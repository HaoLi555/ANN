...
if __name__=="__main__":    
    datadir="/home/haoooooooooooookkkkk/sophomore_autumn/ANN/HW2/cifar-10-batches-py"
    load_cifar_2d(data_dir=datadir)